...
<div class="container">
	...
	@endif
	<div class="container">
        <form class="needs-validation" action="/admin/homepage/slider/new" method="POST" enctype="multipart/form-data" novalidate>
		@csrf
		<div class="row">
		    <div class="col-md-8">
			    <div class="container info-cont">
				    <div class="form-row">
					    <div class="col-6 mb-3">
							...
							<input type="text" class="form-control @error('text') is-invalid @enderror" id="validationCustom01" name="text" placeholder="e.g. Shop Now" value="{{old('text')}}" required>
							@error('text')
						...
						<div class="col-6 mb-3">
							...
							<input type="text" class="form-control @error('btnlink') is-invalid @enderror" id="validationCustom02" name="btnlink" placeholder="e.g. /shop/tea" value="{{old('btnlink')}}" required>
							@error('btnlink')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
