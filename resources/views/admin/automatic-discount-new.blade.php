...
<div class="container">
	    ...
	    <div class="row">
		    ...
		    <div class="col-md-9 p-0">
			    <table style="width:100%;height:100%"><tr><td class="align-middle" style="width:100%;height:100%">
				    <div class="heading2">Create automatic discount</div>
				</td></tr></table>
			</div>
		</div>
	</div>
	...
	@endif
	<div class="container">
        <form class="needs-validation" action="/admin/discounts/automatic/new" method="POST" onsubmit="return validateForm()" novalidate>
		@csrf
		    <div class="row">
		        <div class="col-md-8">
		    	    <div class="container info-cont">
		    		    ...
		    		    <div class="form-row">
		    			    <div class="col-12">
		    					<input type="text" class="form-control mb-2" id="validationCustom01" name="discountTitle" placeholder="e.g. New year promotion" value="{{old('discountTitle')}}" autofocus required>
		    		...
		    		<div class="container info-cont">
		    			...
		    			<div class="form-row">
                            ...
                            <div class="col-4">
		    					<input type="number" class="form-control priceInput" id="validationCustom05" name="discountMinPurchaseAmt" value="{{old('discountMinPurchaseAmt')}}" required>
