...
<div class="container">
	    ...
	    <div class="row">
		    ...
		    <div class="col-md-9 p-0">
			    <table style="width:100%;height:100%"><tr><td class="align-middle" style="width:100%;height:100%">
				    <div class="heading2">{{$discountCode['discountCode']}}</div>
				</td></tr></table>
			</div>
		</div>
	</div>
	...
	@endif
	<div class="container">
        <form class="needs-validation" action="/admin/discounts/code/{{$discountCode['id']}}" method="POST" onsubmit="return validateForm()" novalidate>
		@csrf
		    <div class="row">
		        <div class="col-md-8">
		    	    <div class="container info-cont">
		    		    ...
		    		    <div class="form-row">
		    			    <div class="col-12">
		    					<input autofocus type="text" class="form-control @error('discountCode') is-invalid @enderror mb-2" id="validationCustom01" name="discountCode" placeholder="e.g. MYFIRST10" value="{{$discountCode['discountCode']}}{{old('discountCode')}}" required>
		    		...
		    		<div class="container info-cont">
		    			...
		    			<div class="form-row">
                            <div class="col-4">
		    					...
		    					<input type="number" class="form-control percentageInput" id="validationCustom03" name="discountValue" value="{{$discountCode['discountValue']}}{{old('discountValue')}}" required>
		    	...
		    	<div class="col-md-4">
		    		...
		    		<div class="container info-cont">
					    ...
					    <div class="custom-control custom-checkbox">
						    <input type="checkbox" class="custom-control-input" id="validationCustom08" name="discountOncePerUser" value="Yes" @if($discountCode['discountOncePerUser'] == "Yes") checked @endif>
...
<script>
	...
	function deleteCode(){
		$.ajax({
            url: '/admin/discounts/code/{{$discountCode["id"]}}',
            method: "DELETE",
            data: {_token: '{{ csrf_token() }}'},
