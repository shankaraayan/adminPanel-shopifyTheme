	    ...
	    <div class="row">
		    <div class="col-6">
			    <table class="table-borderless" style="width:100%;height:100%"><tr><td class="align-middle pl-0" style="width:100%;height:100%">
					<h1 class="heading1">Image with text 2</h1>
				</td></tr></table>
			</div>
			<div class="col-6 text-right">
			    <button class="btn btn-primary" onclick="window.location.href='/admin/homepage/services/new'">Add slider</button>
			</div>
		</div>
	</div>
        	...
        	<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="pills-home-tab">
	            <table class="table">
                	...
                	<tbody>
		        		...
		        		<tr class="table-row" data-href="/admin/homepage/services/{{$banner['id']}}">
                			<td>
								...
								@else
									<img class="img-fluid" src="/storage/services/{{$banner['banner_img']}}" />
								@endif
							</td>
                			<td style="width:50%">
							    <table class="table-borderless" style="width:100%;height:100%"><tr><td class="align-middle pl-0" style="width:100%;height:100%">
