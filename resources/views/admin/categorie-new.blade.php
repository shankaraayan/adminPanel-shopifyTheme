	    ...
	    <div class="row">
		    ...
		    <div class="col-md-9 p-0">
			    <table style="width:100%;height:100%"><tr><td class="align-middle" style="width:100%;height:100%">
				    <div class="heading2">Create category</div>
				</td></tr></table>
			</div>
		</div>
	</div>
					...
					<div class="row">
					    <div class="col-12 text-center">
					        <div class="custom-file pt-5" style="border:2px solid #dddddd;border-style:dashed;padding-bottom:150px;">
					        	...
					        	<input type="file" class="inputMedia inputfile" id="validationCustom04" accept=".jpg" name="categoryImage[]">
				...
				<div class="container info-cont">
					...
					<div class="row">
					    <div class="col-12 text-center">
					        <div class="custom-file pt-5" style="border:2px solid #dddddd;border-style:dashed;padding-bottom:150px;">
                                <p class="text-center"><i style="font-size:40px;" class="fas fa-arrow-circle-up"></i></p>
					        	<input type="file" class="inputMedia1 inputfile" id="validationCustom05" accept=".jpg" name="categoryBanner[]">
