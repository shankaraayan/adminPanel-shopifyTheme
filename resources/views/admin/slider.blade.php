...
<div class="container">
    <div class="container mb-5">
	    <div class="row">
		    <div class="col-md-1">
			    <button class="btn btn-secondary" onclick="window.location.href='/admin/homepage/slider'"><i class="fas fa-long-arrow-alt-left"></i></button>
			</div>
	...
	@endif
	<div class="container">
        <form class="needs-validation" action="/admin/homepage/slider/{{$banner['id']}}" method="POST" enctype="multipart/form-data" novalidate>
		@csrf
		<div class="row">
		    <div class="col-md-8">
			    <div class="container info-cont">
				    <div class="form-row">
					    <div class="col-6 mb-3">
							...
							<input type="text" class="form-control @error('text') is-invalid @enderror" id="validationCustom01" name="text" placeholder="e.g. Shop Now" value="{{old('text',$banner['bannerBtn_text'])}}" required>
							@error('text')
						...
						<div class="col-6 mb-3">
							...
							<input type="text" class="form-control @error('btnlink') is-invalid @enderror" id="validationCustom02" name="btnlink" placeholder="e.g. /shop/tea" value="{{old('btnlink',$banner['bannerBtn_link'])}}" required>
							@error('btnlink')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
			...
			<div class="col-md-4">
				<div class="container info-cont">
				    <h3 class="info-cont-heading">Banner (720*820 px)</h3>
					<div class="row">
					    <div class="col-12 text-center">
							...
							@else
							    <img class="img-fluid" src="/storage/sliders/{{$banner['banner_img']}}" data-toggle="modal" data-target="#updateBanner" data-whatever="{{$banner['banner_img']}}" style="cursor:pointer"/>
							@endif
		                </div>
		            </div>
				</div>
		...
		<div class="container proButtons">
		    <div class="row">
			    <div class="col-6 p-0">
			        <a href="/admin/homepage/slider/{{$banner->id}}/delete" class="btn btn-danger">Delete</a>
			    </div>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="needs-validation" action="/admin/homepage/slider/{{$banner->id}}/image" method="POST" enctype="multipart/form-data" novalidate>
				@csrf
				<div class="form-row">
                    <div class="col-12 mb-3">
