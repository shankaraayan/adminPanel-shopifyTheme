	    ...
	    <div class="row">
		    <div class="col-6">
			    <table class="table-borderless" style="width:100%;height:100%"><tr><td class="align-middle pl-0" style="width:100%;height:100%">
					<h1 class="heading1">Sub Categories</h1>
				</td></tr></table>
			</div>
			<div class="col-6 text-right">
			    <button class="btn btn-primary" onclick="window.location.href='/admin/sub-categories/new'">Add sub category</button>
			</div>
		</div>
	</div>
        	...
        	<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="pills-home-tab">
	            <table class="table">
                	...
                	<tbody>
		        		...
		        		<tr class="table-row" data-href="/admin/sub-categories/{{$categorie['id']}}">
                			<td>
							    <div class="img-block mr-0" style="background-image:url('/storage/sub-categories/{{$categorie['subCategoryImage']}}');"></div>
							</td>
                			<td>
							    <table class="table-borderless" style="width:100%;height:100%"><tr><td class="align-middle pl-0" style="width:100%;height:100%">
                			...
                			<td>
							    <table class="table-borderless" style="width:100%;height:100%"><tr><td class="align-middle pl-0" style="width:100%;height:100%">
								    Product sub category is equal to @php echo strtolower($categorie['subCategory']) @endphp
								</td></tr></table>
							</td>
                		</tr>
		        		@endforeach
